...
export class BookSearchPage {
    ...
    constructor( public navCtrl: NavController, public navParams: NavParams, private app: App, public repositoryBookService: RepositoryBookService, public loadingCtrl: LoadingController ) {
